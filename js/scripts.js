$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Katharina and Paulo's wedding",

            // Event start date
            start: new Date('Jun 25, 2021 10:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'fd80c4b06025c38f9d6958ebe4f14532') {
            //&& MD5($('#invite_code').val()) !== '2ac7f43695eb0479d5846bb38eec59cc') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbzggYDitkGwlCHWXC9gVHRLAf_2xfloWnycf3XuePj0e_Yw9XNa/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lng: -7.913500037686701, lat: 38.5692779591021};
