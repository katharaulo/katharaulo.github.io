...
// constants from https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSSchedule_Ref/index.html#//apple_ref/doc/constant_group/FSEventStreamEventFlags
